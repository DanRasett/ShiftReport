...
export interface CalculationResult { dashTotal: number; factTotal: number; twoPercent: number; expensesTotal: number; difference: number; }
export interface FineRecord { id: string; workerName: string; amount: number; reason: string; date: string; paid: boolean; }
